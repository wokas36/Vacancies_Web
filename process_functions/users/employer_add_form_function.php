<?php
function investigator_add_form(){
?>
    <header class="content_header">
    <h3>New Employer add form</h3>
    </header>

    <form action="./process_functions/process_functions.php?action=investigator_add" method="post" onSubmit="return eafFormValidate();">
    <fieldset>
	...
	<div class="input_group">
        ...
        <div class="width_pcnt_80 float_left">
        <label class="control-label" for="input">Previous Experiance <span class="required_text">*</span></label>
        <textarea class="width_pcnt_90" placeholder="Experiance" rows="2" name="experiance" id="experiance"></textarea>
        </div>
        <div class="clear"></div>
    </div>
...
function eafFormValidate(){
	...
	var epf_no=document.getElementById('epf_no');
	checkEmpty(epf_no);
